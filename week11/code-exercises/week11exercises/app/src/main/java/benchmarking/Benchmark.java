...
public class Benchmark {
  ...
  public static double Mark7(String msg, IntToDoubleFunction f) {
    ...
    double mean = st/n, sdev = Math.sqrt((sst - mean*mean*n)/(n-1));
    System.out.printf("%-25s %15.1f mS %10.2f %10d%n", msg, mean/1e6, sdev, count); // result in secs
    //System.out.printf("%-25s %15.1f nS %10.2f %10d%n", msg, mean, sdev, count); // result in nS
    return dummy / totalCount;
  }
