...
Code can be used to demonstrate 
   ...
   4. sanity check to show that running time grows linearly with number of itereations in threads
*/

// jst@itu.dk * 2024-02-05
...
public class SocketCountingThreads{
  ...
  public class TransactionThread extends Thread {
    ...
    public void run() {
      ...
      //serverLocking(); 
      clientLocking();
      /*int res= localIncrement();
      sendMessage("put&"+res); // attempt to avoid Java from optimizing the computation in this method*/
    }
  }
